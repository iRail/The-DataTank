...
class UniversalInterpreter implements IInterpreterControl{
    ...
    public function __construct($tablemanager) {
        ...
        $this->executers = array(
            ...
            UnairyFunction::$FUNCTION_UNAIRY_SIN => "UnaryFunctionSinExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_COS => "UnaryFunctionCosExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_TAN => "UnaryFunctionTanExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_ASIN => "UnaryFunctionAsinExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_ACOS => "UnaryFunctionAcosExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_ATAN => "UnaryFunctionAtanExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_SQRT => "UnaryFunctionSqrtExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_ABS => "UnaryFunctionAbsExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_FLOOR => "UnaryFunctionFloorExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_CEIL => "UnaryFunctionCeilExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_EXP => "UnaryFunctionExpExecuter",
            UnairyFunction::$FUNCTION_UNAIRY_LOG => "UnaryFunctionLogExecuter",
